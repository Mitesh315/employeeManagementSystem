...
public class EmployeesServiceImpl implements EmployeesService{
	...
	@Override
	public void updateDepartment(long departmentId, long id) {
		employeesRepository.updateDepartment(id, departmentId);
	}

	@Override
	public List<Employees> getSortedList() {
		return employeesRepository.getSortedList();
	}

	@Override
	public List<Employees> getPaginatedList(int page, int limit) {
		return employeesRepository.getPaginatedList(page, limit);
	}
